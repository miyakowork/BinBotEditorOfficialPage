...
export const releaseStatus = {
  label: '下载 macOS 正式版',
  notice: 'v0.2.4 适用于 Apple Silicon，当前版本未经 Apple 公证；首次启动时可能需要在“隐私与安全性”中确认打开。',
  available: true,
  downloadUrl: 'https://github.com/miyakowork/BinBotEditorOfficialPage/releases/download/v0.2.4/BinBotEditor-0.2.4-macOS-arm64.dmg',
} as const
...
export const faqItems = [
  {
    ...
    answer: 'v0.2.4 适用于搭载 Apple Silicon 的 Mac。',
  },
  {
    id: 'release-date',
    question: '什么时候可以下载？',
    answer: 'v0.2.4 已开放下载，当前提供 macOS Apple Silicon 正式版。',
  },
  {
    id: 'local-files',
    question: '代码会上传到云端吗？',
